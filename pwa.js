(() => {
  ...
  loadScriptOnce('./src/app/girls-default-sort.js?v=1', 'girls-default-sort');\n  loadScriptOnce('./src/app/game-app-enhancements.js?v=6', 'game-app-enhancements');
  loadScriptOnce('./src/app/gacha-history.js?v=2', 'gacha-history');
  loadScriptOnce('./src/app/team-logo-overrides.js?v=8', 'team-logo-overrides');
  loadScriptOnce('./src/app/girl-career.js?v=4', 'girl-career');
