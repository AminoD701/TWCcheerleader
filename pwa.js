(() => {
  ...
  const TEAM_LOGO_OVERRIDES = [
    { names: ['ACE VIVA', 'Ace Viva', 'Ace VIVA'], logo: './images/ace_viva_logo.jpg' },
    { names: ['Si-ster', 'Si-ster 可莉女孩', 'SiSter', 'SI-STER'], logo: './images/sister_logo.jpg' }
  ];
  ...
  loadScriptOnce('./src/app/team-logo-overrides.js?v=2', 'team-logo-overrides');
