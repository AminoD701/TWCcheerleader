...
if old_promise in text:
    ...
    print('Warning: Promise.all block not found or already patched')
...
# The file currently has this assignment twice. Replace both so later code does not discard automatic news.
text = text.replace(old_dbnews, new_dbnews)

# Add an original-source button inside news modal for automatically collected items (or any manual row with url).
...
if text == original:
    ...
    print('Automatic news integration patched successfully.')
